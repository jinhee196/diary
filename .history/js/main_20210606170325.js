...
const back = document.querySelectorAll('.fa-chevron-left');
const morning__submit = document.querySelector('.morning__submit');
...
morning__submit.addEventListener('click', ()=>{
  popup.style.display = 'block';
  popupBtn.addEventListener('click', ()=>{
    popup.style.display = 'none';
    init();
...
back[0].addEventListener('click', init);
back[1].addEventListener('click', init);
